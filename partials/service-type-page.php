        ...
        <section class="page__services-page">
            <div class="services-page__body _container">
                <div class="services-page__info-block">
                    ...
                    Добро пожаловать на страницу специализированных процедур нашего центра гармонии души и тела "Лотос". Здесь вы найдете все необходимые процедуры, направленные на глубокое восстановление и улучшение вашего физического и эмоционального состояния. Каждая процедура разработана с учетом индивидуальных потребностей наших клиентов, чтобы обеспечить максимальный эффект и комфорт.
                    </p>
                </div>
            </div>
            </div>
