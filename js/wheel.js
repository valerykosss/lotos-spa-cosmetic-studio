...
// // const prizes = [
// //     {
// //       text: "Скидка 25% на косметологическую процедуру",
// //       color: "hsl(147 21% 61%)",
// //     },
// //     { 
// //       text: "Cкидка 20% на комплексный массаж тела ",
// //       color: "hsl(148 13% 45%)",
// //     },
// //     { 
// //       text: "Скидка 15% на первую чистку",
// //       color: "hsl(148 15% 81%)",
// //     },
// //     {
// //       text: "Бесплатный массаж шеи и плеч",
// //       color: "hsl(147 43% 86%)",
// //     },
// //     {
// //       text: "Консультация и мини-пробник в подарок",
// //       color: "hsl(140 36% 74%)",
// //     },
// //     {
// //       text: "Скидка 30% для спа на двоих",
// //       color: "hsl(147 20% 64%)",
// //     }
// //   ];
...
// создаём функцию для рисования секторов
...
// рисуем разноцветные секторы
const createConicGradient = (prizeSlice) => {
    // устанавливаем нужное значение стиля у элемента spinner
    spinner.setAttribute(
        "style",
        `background: conic-gradient(
...
const setupWheel = () => {
    ...
    // сначала секторы
    createConicGradient(prizeSlice);
    // потом текст
...
const runTickerAnimation = () => {
    // взяли код анимации отсюда: https://css-tricks.com/get-value-of-css-rotation-through-javascript/
    const values = spinner.style.transform.split("(")[1].split(")")[0].split(",");
    const a = values[0];
    const b = values[1];
    let rad = Math.atan2(b, a);
...
const selectPrize = () => {
    ...
    prizeNodes[selected].classList.add("selected");
       ...
       // Выводим текст сектора в alert
    alert(`Колесо остановилось на секторе: ${selectedPrize}`);
};
